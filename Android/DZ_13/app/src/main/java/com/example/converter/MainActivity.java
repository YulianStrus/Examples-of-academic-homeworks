...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBuy(View view) {
        mTextViewRes.setText(String.valueOf(valB * Double.valueOf(mEditText.getText().toString())) + " грн");
    }

    public void onSelling(View view) {
        mTextViewRes.setText(String.valueOf(valS * Double.valueOf(mEditText.getText().toString())) + " грн");
    }
}